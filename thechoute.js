...
Recuerda siempre seguir las reglas y mantener una formalidad respetuosa`
    ...
    {"title": 'Bot Para Multimedia',       
    "body": 'Facil y Rapido',  
    "thumbnail": fs.readFileSync('./media/imagen/youtube-mi.jpg'),
    "sourceUrl": 'https://www.facebook.com/VeinTiiUno'}}})
...
const command = comm
  ...
  const ownerNumber = "18098534037@s.whatsapp.net"
  const Oowner  = "18098534037@s.whatsapp.net"
  const the34 = "8098534037@s.whatsapp.net"
...
Mi Facebook: https://www.facebook.com/VeinTiiUno`
const quecanciones = `
...
Facebook https://www.facebook.com/VeinTiiUno`
...
if (choute.message.listResponseMessage){
  ...
  leo.updatePresence(from, Presence.composing)
  if (!isRegister) return reply(baby.only.usrReg)
tampa = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 9999999, "message": `${reglas}`, "footerText": "*Diomedes*", "thumbnail": fs.readFileSync('./media/imagen/imgregla.jpg'), "surface": 'CATALOG' }}, {contextInfo: { mentionedJid: [sender,Oowner]}, quoted:choute, })
...
if (choute.message.listResponseMessage){
  ...
  buttonsMessage = {
  contentText: `${txtt}`,
  footerText: '© Creator Diomedes\nFacebook: https://www.facebook.com/VeinTiiUno', imageMessage: imageMsg,
  buttons: buttons1,
  headerType: 4}
...
if (choute.message.listResponseMessage){
  ...
  `${texto}\n${allmenu}`
    ...
    buttonsMessage = {
    contentText: `${txtt}`,
    footerText: '© Creator Diomedes', imageMessage: imageMsg,
    buttons: buttons1,
    headerType: 4}
...
case 'ban':
                ...
                buttons: buttons1,
                headerType: 4}} 
                else if (isQuotedMsg) {if (quotedMsg.sender.match('18098534037')) return reply(`🤨`)
...
leo.sendMessage('18098534037@s.whatsapp.net', options, text, {quoted: choute})
